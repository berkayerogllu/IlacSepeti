 ...
 * @author berkay
 */
public class SacSekillendirici extends javax.swing.JFrame {
    
    UserOperations operations = new UserOperations();

    /**
     * Creates new form SacSekillendirici
     */
    public SacSekillendirici() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Saç Jölesi - 120₺");

        jLabel2.setText("Saç Köpüğü - 140₺");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
      String urun_adi = "SAÇ KÖPÜĞÜ";
      int urun_adedi = 1;
      double birim_fiyati = 140;
      double toplam_fiyat = urun_adedi*birim_fiyati;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SacSekillendirici.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SacSekillendirici().setVisible(true);
            }
        });
    }
