 ...
 * @author berkay
 */
public class BebekBezleri extends javax.swing.JFrame {
    
    UserOperations operations = new UserOperations();

    /**
     * Creates new form BebekBezleri
     */
    public BebekBezleri() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Molfix 50 Adet Bebek Bezi - 199.99₺");

        jLabel2.setText("Prima 40 Adet Bebek Bezi - 120₺");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
      String urun_adi = "MOLFİX 50 ADET BEBEK BEZİ";
      int urun_adedi = 1;
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
      String urun_adi = "PRİMA 40 ADET BEBEK BEZİ";
      int urun_adedi = 1;
      double birim_fiyati = 160;
      double toplam_fiyat = urun_adedi*birim_fiyati;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BebekBezleri.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new BebekBezleri().setVisible(true);
            }
        });
    }
